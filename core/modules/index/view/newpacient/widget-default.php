<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="rut" required class="form-control" id="rut" placeholder="rut"> - <input type="text" name="check_digit" required class="form-control" id="check_digit" placeholder="Digito verificador">
