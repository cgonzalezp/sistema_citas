    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Sistema de citas <sup><small><!--<span class="label label-info">v1.0</span>--></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=categories"><i class="fa fa-th-list"></i> Box</a></li>
          <?php if($u->is_admin):?>
