  ...
  <div class="form-group">
    ...
    <div class="col-lg-2">
		<div class="input-group">
		  ...
		  <input name="pacient_id" class="form-control" placeholder="Paciente"></input>
...
<option value="">PACIENTE</option>
  ...
  <?php endforeach; ?>
	...
	<input name="medic_id" class="form-control" placeholder="Medico"></input>
...
if($_GET["q"]!=""){
	...
	//$sql2= "select id from pacient like name '%$_GET[q]%' or lastname like '%$_GET[q] %' ";
	echo $sql .= " pacient_id = ".$_GET["pacient_id"];
}
